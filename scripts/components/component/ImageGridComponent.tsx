...
import { Props, State} from "../interface/ImageGridComponentInterface"
    ...
    switch(length){
      ...
      case 3:
        return (
          <View style={{flex:1}}>
            ...
            <View style={{width:PADDING}}/>
            <View style={{flex:1}}>
              <Image style={[{flex:1, height:smallHeight}]} source={this.props.imageSourceList[1]} resizeMode="cover"/>
              <View style={{height:PADDING}}/>
              <Image style={[{flex:1, height:smallHeight}]} source={this.props.imageSourceList[2]} resizeMode="cover"/>
            </View>
          </View>
        )
      case 4:
      default:
        return (
          <View style={{flex:1}}>
            <View style={{flex:1}}>
              <Image style={[{flex:1, height:smallHeight}]} source={this.props.imageSourceList[0]} resizeMode="cover"/>
              <View style={{height:PADDING}}/>
              <Image style={[{flex:1, height:smallHeight}]} source={this.props.imageSourceList[1]} resizeMode="cover"/>
            </View>
            <View style={{width:PADDING}}/>
            <View style={{flex:1}}>
              <Image style={[{flex:1, height:smallHeight}]} source={this.props.imageSourceList[2]} resizeMode="cover"/>
              <View style={{height:PADDING}}/>
              <Image style={[{flex:1, height:smallHeight}]} source={this.props.imageSourceList[3]} resizeMode="cover"/>
            </View>
          </View>
        )
    }
